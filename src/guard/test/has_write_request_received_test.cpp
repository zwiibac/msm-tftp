...
class HasWriteRequestReceivedTest : public ::testing::Test
{
protected:
    ...
    HasWriteRequestReceived sut;
};

TEST_F(HasWriteRequestReceivedTest, Do) 
{
    // arrange
...
TEST_F(HasWriteRequestReceivedTest, Fail) 
{
    // arrange
    auto received_header = HeaderProxy::FromBuffer(machine_mock.buffer_);
